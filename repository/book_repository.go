...
type BookRepository interface {
	FindAll(ctx context.Context, p entity.Paging) (*entity.BookPackage, error)
...
func (r *bookRepository) FindAll(ctx context.Context, pagination entity.Paging) (*entity.BookPackage, error) {
